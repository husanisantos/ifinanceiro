              ...
              <form @submit.prevent="submitForm">
                <v-row>
                  ...
                  <v-col cols="12">
                    ...
                    <v-text-field type="date" id="vencimento" v-model="formulario.pagamento" variant="outlined" class="pwdInput" color="primary"></v-text-field>
                  </v-col>
  ...
  export default {
    ...
    methods: {
      async submitForm() {
        ...
        try {
          const response = await axios.post(url, this.formulario, {
            headers: {
